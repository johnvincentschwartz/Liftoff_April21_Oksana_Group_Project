...
bikes BOOLEAN,
woods BOOLEAN,
water ENUM('creek', 'lake', 'river', 'pond') NULL,
type ENUM('natural', 'paved', 'gravel', 'partial_paved') NULL
);
...
('DeClue Trail','Eureka','MO',8.4,5,'ChIJJ7h9HGUv2YcRpljMsOS1OAI','DeClue Trail Trailhead',38.527718,-90.683985,'natural',null,true,false,false,false),
...
('Grotpeter Trail','Valley Park','MO',3.7,4,'ChIJQTfu2b3W2IcRoQuh-30L0jI','Grotpeter Trailhead',38.55232,-90.542966, 'natural', null, true, true, false, false),
('Historic Loop Trail','Pine Lawn','MO',1.3,2,'ChIJ1xS2_M-12IcRLpE3S8ws0UI','Forest park trail',38.645458,-90.275734, 'gravel', null, true, true, true, false),
...
--('Grants Trail','Oakland','MO',8.4,1,'Eh9HcmFudCdzIFRyYWlsLCBPYWtsYW5kLCBNTywgVVNBIi4qLAoUChIJv1chvBLJ2IcRkx65J5C-5rgSFAoSCbuDZuYazNiHERgrcolSMGNx','Grant\'s Trail',38.569753,-90.390563, 'paved', null, false, false, false, true),
...
--('River des Peres Greenway Trail','Shrewsbury','MO',5,2,'ChIJ4Z8Ww2W22IcRcTGKzlToq5A','River Des Peres Greenway',38.564598,-90.297694, 'paved', null, false, true, true, true),
--('Deer Creek Greenway','Maplewood','MO',0.6,1,'EidEZWVyIENyZWVrIEdyZWVud2F5LCBNYXBsZXdvb2QsIE1PLCBVU0EiLiosChQKEgl3RgbzUMrYhxEmPMJvhiqw9xIUChIJy9pY4YnK2IcRXco2sfA0JQw','Deer Creek Greenway',38.603183,-90.330672, 'paved', null, false, true, true, true),
...
--('St. Stanislaus Truman Park Connector Trail','Hazelwood','MO',3.5,1,'ChIJtZl9k8sw34cRlxXqdi6rzFQ','Missouri Greenway Trailhead: Harry S Truman Park',38.795414,-90.37925, 'partial_paved', null, false, true, false, false),
...
--('St. Vincent Greenway','Cool Valley','MO',3.6,3,'ChIJKa9Bvpo134cRdBIjIUx6nVk','Saint Vincent Greenway',38.708491,-90.31079, 'paved', null, false, false, true, true),
...
--('Maple Tree Trail','Bellefontaine Neighbors','MO',1.4,1,'EjhNYXBsZSBUcmVlIFRyYWlsLCBCZWxsZWZvbnRhaW5lIE5laWdoYm9ycywgTU8gNjMxMzcsIFVTQSIuKiwKFAoSCVNgfvNZSd-HEZJg-5bFXjE3EhQKEgkPWmx-TEnfhxH64uqkLzo-xQ','Maple Tree Trail',38.741213,-90.234982, 'paved', null, false, false, false, true),
--('Turkey Ridge Trail','Wildwood','MO',1.9,3,'ChIJPTcE56gp2YcRmhWy-K45DRM','Western Greenway Trailhead: Turkey Ridge Trail',38.55648,-90.642854, 'natural', null, true, true, false, false),
...
--('Limestone Hill Trail','Imperial','MO',2,4,'ChIJOwkZBejD2IcRR4PF6KPj8ts','Limestone Hill Trail',38.379675,-90.384755, 'natural', null, false, true, false, false),
...
--('Dennis Schick Trail','Lemay','MO',1.6,2,'ChIJyZx4wLm32IcRaLJMfjnYKEk','Dennis Schick North Trail',38.515133,-90.276787, 'gravel', null, true, false, false, false),
...
--('Dog Park Trail','Chesterfield','MO',0.4,2,'ChIJWeN4FSjV2IcRfes7T82Xd9M','Eberwein Dog Park',38.642287,-90.564644, 'natural', null, false, true, false, false),
...
--('Ruth Woods Trail - Full Loop','Olivette','MO',0.9,2,'ChIJnzScxsE034cR4FZ1MNnvew4','Ruth Park Nature Trail',38.672492,-90.356779, 'natural', null, true, true, false, false)
;